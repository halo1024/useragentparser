...
func fuzzyBrandMapping() map[string]DeviceBrand {
	return map[string]DeviceBrand{
		"vivo":      DeviceBrandVIVO,
		"oppo":      DeviceBrandOPPO,
		"mi ":       DeviceBrandXiaomi,
		"redmi":     DeviceBrandXiaomi,
		"huawei":    DeviceBrandHuawei,
		"hm ":       DeviceBrandXiaomi,
		"mix ":      DeviceBrandXiaomi,
		"oneplus":   DeviceBrandOPPO,
		"harmonyos": DeviceBrandHuawei,
...
func modelMapping() map[string]DeviceBrand {
	return map[string]DeviceBrand{
		"v1901a":           DeviceBrandVIVO,
		"v2057a":           DeviceBrandVIVO,
		"v1934a":           DeviceBrandVIVO,
		"v2002a":           DeviceBrandVIVO,
		"vivo x21a":        DeviceBrandVIVO,
		"m2012k11ac":       DeviceBrandXiaomi,
		"m2006c3lc":        DeviceBrandXiaomi,
		"m2007j17c":        DeviceBrandXiaomi,
		"m2007j22c":        DeviceBrandXiaomi,
		"redmi note 8 pro": DeviceBrandXiaomi,
		"m2104k10ac":       DeviceBrandXiaomi,
		"redmi note 8":     DeviceBrandXiaomi,
		"redmi k30 5g":     DeviceBrandXiaomi,
		"mi 8":             DeviceBrandXiaomi,
		"mi 6x":            DeviceBrandXiaomi,
		"pbam00":           DeviceBrandOPPO,
		"pbem00":           DeviceBrandOPPO,
		"pdym20":           DeviceBrandOPPO,
		"pdbm00":           DeviceBrandOPPO,
		"pcam10":           DeviceBrandOPPO,
		"pcam00":           DeviceBrandOPPO,
		"pdvm00":           DeviceBrandOPPO,
		"pacm00":           DeviceBrandOPPO,
		"peam00":           DeviceBrandOPPO,
		"oppo r11":         DeviceBrandOPPO,
		"sea-al10":         DeviceBrandHuawei,
		"ele-al00":         DeviceBrandHuawei,
		"tas-an00":         DeviceBrandHuawei,
		"ana-an00":         DeviceBrandHuawei,
		"hlk-al00":         DeviceBrandHuawei,
		"els-an00":         DeviceBrandHuawei,
		"lio-an00":         DeviceBrandHuawei,
		"hma-al00":         DeviceBrandHuawei,
		"jef-an00":         DeviceBrandHuawei,
		"noh-an00":         DeviceBrandHuawei,
	}
}
